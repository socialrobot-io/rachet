...
export const demoPeople = [
  ...
  },
  {
    ...
    events: ['project.created', 'teammate.invited'],
    hoursAgo: 96,
  },
  {
    externalId: 'demo-sam',
  ...
  },
  {
    ...
    events: ['workspace.active', 'subscription.activated'],
    hoursAgo: 72,
  },
  {
  ...
  return [
    {
      ...
      definition: {
        ...
        nodes: [
          ...
          { id: 'wait_first_project', type: 'wait_for_event', eventType: 'project.created', timeoutSeconds: 172800, onEvent: 'wait_teammate_invite', onTimeout: 'send_setup_help' },
          email('send_setup_help', 'setup_help', 'wait_project_after_help', versions),
          { id: 'wait_project_after_help', type: 'wait_for_event', eventType: 'project.created', timeoutSeconds: 432000, onEvent: 'wait_teammate_invite', onTimeout: 'exit_not_activated' },
          { id: 'wait_teammate_invite', type: 'wait_for_event', eventType: 'teammate.invited', timeoutSeconds: 432000, onEvent: 'exit_collaborating', onTimeout: 'send_collaboration_tip' },
    ...
    },
    {
      ...
      definition: {
        ...
        nodes: [
          ...
          { id: 'check_already_paid', type: 'branch', condition: { op: 'event_received', eventType: 'subscription.activated' }, onTrue: 'exit_converted', onFalse: 'check_workspace_active' },
          { id: 'check_workspace_active', type: 'branch', condition: { op: 'event_received', eventType: 'workspace.active' }, onTrue: 'send_trial_value', onFalse: 'send_trial_help' },
          email('send_trial_value', 'trial_value', 'wait_subscription', versions),
          email('send_trial_help', 'trial_help', 'wait_subscription', versions),
          { id: 'wait_subscription', type: 'wait_for_event', eventType: 'subscription.activated', timeoutSeconds: 259200, onEvent: 'exit_converted', onTimeout: 'send_trial_ending' },
          email('send_trial_ending', 'trial_ending', 'wait_last_day', versions),
          { id: 'wait_last_day', type: 'wait_for_event', eventType: 'subscription.activated', timeoutSeconds: 86400, onEvent: 'exit_converted', onTimeout: 'exit_expired' },
    ...
    },
    {
      ...
      definition: {
        ...
        nodes: [
          ...
          { id: 'wait_for_return', type: 'wait_for_event', eventType: 'session.started', timeoutSeconds: 604800, onEvent: 'exit_returned', onTimeout: 'exit_no_return' },
